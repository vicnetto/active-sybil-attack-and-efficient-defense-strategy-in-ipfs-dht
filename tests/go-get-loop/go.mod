...
require (
	...
	github.com/vicnetto/active-sybil-attack/node/peer v0.0.0-20240717092708-1083a666576e
)
...
replace github.com/libp2p/go-libp2p-kad-dht => ../../lib/go-libp2p-kad-dht-pr-info
