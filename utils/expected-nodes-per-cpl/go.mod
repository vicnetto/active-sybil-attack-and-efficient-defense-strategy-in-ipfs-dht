...
require (
	...
	github.com/vicnetto/active-sybil-attack/logger v0.0.0-20250120102219-254a63da6821 // indirect
...
replace github.com/ssrivatsan97/go-libp2p-kad-dht/eclipse-detection => ../../go-libp2p-kad-dht/eclipse-detection
